...
class SupermodelIoLogisticsExpressTrackingResponseShipmentsItemPiecesItemEventsItem
{
     ...
     * 
     *
     * @var list<SupermodelIoLogisticsExpressTrackingResponseShipmentsItemPiecesItemEventsItemServiceAreaItem>
     */
     ...
     * 
     *
     * @return list<SupermodelIoLogisticsExpressTrackingResponseShipmentsItemPiecesItemEventsItemServiceAreaItem>
     */
     ...
     * 
     *
     * @param list<SupermodelIoLogisticsExpressTrackingResponseShipmentsItemPiecesItemEventsItemServiceAreaItem> $serviceArea
     *
     * @return self
     */
