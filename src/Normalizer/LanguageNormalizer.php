...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LanguageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntibodiesOnline\DHL\Api\Model\Language::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \AntibodiesOnline\DHL\Api\Model\Language::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntibodiesOnline\DHL\Api\Model\Language();
            ...
            if (\array_key_exists('languageScriptCode', $data)) {
                ...
                unset($data['languageScriptCode']);
            }
            if (\array_key_exists('languageCountryCode', $data)) {
                $object->setLanguageCountryCode($data['languageCountryCode']);
                unset($data['languageCountryCode']);
            }
            if (\array_key_exists('languageOk', $data)) {
                $object->setLanguageOk($data['languageOk']);
                unset($data['languageOk']);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('languageOk') && null !== $object->getLanguageOk()) {
                $data['languageOk'] = $object->getLanguageOk();
            }
        ...
        {
            return [\AntibodiesOnline\DHL\Api\Model\Language::class => false];
        }
    }
} else {
    class LanguageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
